...
<?
$acceptedx = num_accepted_for_this_typename("BIS Work Packages Address Book Sync");

$rejectedx = num_rejected_for_this_typename("BIS Work Packages Address Book Sync");	
...
echo "BIS Work Packages Address Book Sync  ";
...
<div id="accordion" class="accord">
    ...
    ." WHERE t.type_name LIKE '%BIS Work Packages Address Book Sync%' AND t.active = 1 ORDER BY e.mail_id DESC";
