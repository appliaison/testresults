...
<?
$acceptedx = num_accepted_for_this_typename("Orbiter");

$rejectedx = num_rejected_for_this_typename("Orbiter");	
...
<div id="accordion" class="accord">
    ...
    ." WHERE t.type_name LIKE '%Orbiter%' AND t.active = 1 ORDER BY e.mail_id DESC";
