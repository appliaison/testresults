...
<?
$acceptedx = num_accepted_for_this_typename("PUB Handheld App");

$rejectedx = num_rejected_for_this_typename("PUB Handheld App");	
...
<div id="accordion" class="accord">
    ...
    ." WHERE t.type_name LIKE '%PUB Handheld App%' AND t.active = 1 ORDER BY e.mail_id DESC";
