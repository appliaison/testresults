...
<?
$acceptedx = num_accepted_for_this_typename("Fermion");

$rejectedx = num_rejected_for_this_typename("Fermion");	
...
<div id="accordion" class="accord">
    ...
    ." WHERE t.type_name = 'Fermion' AND c.active = '1' ORDER BY codeline_name DESC";
	...
	$accepted = num_accepted_for_this_codeline_and_typename($codeline_id, "Fermion");
	$rejected = num_rejected_for_this_codeline_and_typename($codeline_id, "Fermion");
	// end of accept-reject
	?>
	<h3>	
	<a onclick="populate_bundles_generic_unbounded('<?=$codeline_id?>', '<?=$type_id?>')"><?=$fetch['codeline_name']?> 
