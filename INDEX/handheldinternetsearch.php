...
<?
$acceptedx = num_accepted_for_this_typename("Handheld Internet Search");

$rejectedx = num_rejected_for_this_typename("Handheld Internet Search");	
...
<div id="accordion" class="accord">
    ...
    ." WHERE t.type_name LIKE '%Handheld Internet Search%' AND t.active = 1 ORDER BY e.mail_id DESC";
