...
$accepted = num_accepted_for_this_typename("Bootrom");

$rejected = num_rejected_for_this_typename("Bootrom");	
...
<div id="accordion" class="accord">
    ...
    ." WHERE t.type_name LIKE '%Bootrom%' AND t.active = 1 ORDER BY e.mail_id DESC";
	...
	?>
	<h3><a onchange="populate_bundles_generic_unbounded('<?=$fetch['mail_id']?>',<?=$type_id?> )">
	<?
	if ($fetch['status']=='N')
	{
	echo "<img src='images/x.png' width='13px' title='rejected' alt='rejected'/>";
