...
<?
$acceptedx = num_accepted_for_this_typename("Bug Collector");

$rejectedx = num_rejected_for_this_typename("Bug Collector");	
...
<div id="accordion" class="accord">
    ...
    ." WHERE t.type_name LIKE '%Bug Collector%' AND t.active = 1 ORDER BY e.mail_id DESC";
