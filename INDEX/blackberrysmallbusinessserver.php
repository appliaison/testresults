...
<?
$acceptedx = num_accepted_for_this_typename_return_inactives("BlackBerry Small Business Server");

$rejectedx = num_rejected_for_this_typename_return_inactives("BlackBerry Small Business Server");	
...
echo "BlackBerry Small Business Server   ";
...
<div id="accordion" class="accord">
    ...
    ." WHERE t.type_name LIKE '%BlackBerry Small Business Server%' AND c.active = '1' ORDER BY codeline_name DESC";
	...
	$accepted = num_accepted_for_this_codeline_and_typename_return_inactives($codeline_id, "BlackBerry Small Business Server");
	$rejected = num_rejected_for_this_codeline_and_typename_return_inactives($codeline_id, "BlackBerry Small Business Server");
	?>
