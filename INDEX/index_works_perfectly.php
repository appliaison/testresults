...
return this.each(function () {
    ...
    function spy() {
		...
		var dataToPush = "<li> Ajax Error: Failed to receive data </li>";
		...
		ajaxRequest.onreadystatechange = function(){
			...
			if(ajaxRequest.readyState == 4){
				...
				dataToPush = ajaxRequest.responseText;
				
				if (firstAssignment)
				{
					previousItem = dataToPush;
					firstAssignment = false;
				}
				if (previousItem != dataToPush)
				{
				// insert a new item with opacity and height of zero
				var $insert = $(dataToPush).css({
					height : 0,
					opacity : 0,
					display : 'none'
				}).prependTo($list);
				...
				//PUT AN ELSE HERE TO ADD IN CONSTANT SCROLLING THE WAY DAS WANTED. 
				//CANNOT FIGURE OUT THE $INSERT = $( "cannot figure out this" ).css etc
...
switch ($_GET['type']) 
{
    ...
    case "handheld_smoke":
        ...
        break;
	case "handheld_regression":
        include 'handheld_regression.php';
        break;	
