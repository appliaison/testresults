...
<?
$acceptedx = num_accepted_for_this_typename_return_inactives("Lemonade");

$rejectedx = num_rejected_for_this_typename_return_inactives("Lemonade");	
...
<div id="accordion" class="accord">
    ...
    ." WHERE t.type_name LIKE '%Lemonade%' AND t.active = 1 ORDER BY e.mail_id DESC";
	*/
	...
	. " e.mail_subjectline AS mail_subjectline, e.status AS status FROM email AS e "
	. " LEFT JOIN type AS t ON t.type_id = e.type_id "
    ." WHERE t.type_name LIKE '%Lemonade%' ORDER BY e.mail_id DESC";
