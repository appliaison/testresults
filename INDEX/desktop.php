...
<?
$acceptedx = num_accepted_for_this_typename_return_inactives("Desktop");

$rejectedx = num_rejected_for_this_typename_return_inactives("Desktop");	
...
<div id="accordion" class="accord">
    ...
    ." WHERE t.type_name LIKE '%Desktop%' AND c.active = '1' ORDER BY codeline_name DESC";
	...
	$accepted = num_accepted_for_this_codeline_and_typename_return_inactives($codeline_id, "Desktop");
	$rejected = num_rejected_for_this_codeline_and_typename_return_inactives($codeline_id, "Desktop");
	?>
