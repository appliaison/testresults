...
$accepted = num_accepted_for_this_typename("cfp");

$rejected = num_rejected_for_this_typename("cfp");	
...
<div id="accordion" class="accord">
    ...
    ." WHERE t.type_name LIKE '%cfp%' AND t.active = 1 ORDER BY e.mail_id DESC";
