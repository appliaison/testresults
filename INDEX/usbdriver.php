...
<?
$accepted = num_accepted_for_this_typename("USB Driver");

$rejected = num_rejected_for_this_typename("USB Driver");	
...
<div id="accordion" class="accord">
    ...
    ." WHERE t.type_name LIKE '%USB Driver%' AND t.active = 1 ORDER BY e.mail_id DESC";
