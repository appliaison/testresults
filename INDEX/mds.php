...
<?
$acceptedx = num_accepted_for_this_typename("MDS");

$rejectedx = num_rejected_for_this_typename("MDS");	
...
<div id="accordion" class="accord">
	...
	<?
	require 'db.php';
	$sql = "SELECT t.active, c.codeline_name AS codeline_name, c.codeline_id AS codeline_id, t.type_id AS type_id FROM codeline AS c "
	...
	$accepted = num_accepted_for_this_codeline_and_typename_return_inactives($codeline_id, "MDS");
	$rejected = num_rejected_for_this_codeline_and_typename_return_inactives($codeline_id, "MDS");
	?>
