...
<?
$accepted = num_accepted_for_this_typename("HH VXML");

$rejected = num_rejected_for_this_typename("HH VXML");	
...
<div id="accordion" class="accord">
    ...
    ." WHERE t.type_name LIKE '%HH VXML%' AND t.active = 1 ORDER BY e.mail_id DESC LIMIT 0, 30";
