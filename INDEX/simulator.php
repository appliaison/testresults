...
<?
$accepted = num_accepted_for_this_typename("Simulator");

$rejected = num_rejected_for_this_typename("Simulator");	
...
<div id="accordion" class="accord">
    ...
    ." WHERE t.type_id=330 AND c.active = '1' ORDER BY codeline_name DESC";
	...
	$accepted = num_accepted_for_this_codeline_and_typename($codeline_id, "Simulator");
	$rejected = num_rejected_for_this_codeline_and_typename($codeline_id, "Simulator");
	?>
