...
<?
$accepted = num_accepted_for_this_typename("CD Layout");

$rejected = num_rejected_for_this_typename("CD Layout");	
...
<div id="accordion" class="accord">
    ...
    ." WHERE t.type_name LIKE '%CD Layout%' AND t.active = 1 ORDER BY e.mail_id DESC";
