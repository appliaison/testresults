...
<?
$acceptedx = num_accepted_for_this_typename("Signing Authority");

$rejectedx = num_rejected_for_this_typename("Signing Authority");	
...
<div id="accordion" class="accord">
    ...
    ." WHERE t.type_name LIKE '%Signing Authority%' AND t.active = 1 ORDER BY e.mail_id DESC";
