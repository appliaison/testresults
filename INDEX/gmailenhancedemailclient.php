...
<?
$acceptedx = num_accepted_for_this_typename("GMail Enhanced Email Client");

$rejectedx = num_rejected_for_this_typename("GMail Enhanced Email Client");	
...
echo "GMail Enhanced Email Client  ";
...
<div id="accordion" class="accord">
    ...
    ." WHERE t.type_name LIKE '%GMail Enhanced Email Client%' AND t.active = 1 ORDER BY e.mail_id DESC";
